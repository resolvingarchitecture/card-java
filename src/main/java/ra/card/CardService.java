 ...
 */
public final class CardService extends NetworkService {
    ...
    public CardService(MessageProducer messageProducer, ServiceStatusObserver observer) {
    ...
    public boolean start(Properties p) {
        ...
        try {
            ...
            config = Config.loadAll(p, "card.config");
        } catch (Exception e) {
...
//        sessions.clear();
    ...
    public static void main(String[] args) {
        ...
        CardService service = new CardService(messageProducer, null);
